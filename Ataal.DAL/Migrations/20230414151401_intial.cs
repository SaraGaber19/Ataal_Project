...
namespace Ataal.DAL.Migrations
{
    ...
    public partial class intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "KeyWordsProblem",
                columns: table => new
                {
                    KeyWordsKeyWord_ID = table.Column<int>(type: "int", nullable: false),
                    ProblemsProblem_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeyWordsProblem", x => new { x.KeyWordsKeyWord_ID, x.ProblemsProblem_ID });
                    table.ForeignKey(
                        name: "FK_KeyWordsProblem_KeyWords_KeyWordsKeyWord_ID",
                        column: x => x.KeyWordsKeyWord_ID,
                        principalTable: "KeyWords",
                        principalColumn: "KeyWord_ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KeyWordsProblem_Problems_ProblemsProblem_ID",
                        column: x => x.ProblemsProblem_ID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeyWordsProblem_ProblemsProblem_ID",
                table: "KeyWordsProblem",
                column: "ProblemsProblem_ID");
