...
namespace Ataal.DAL.Migrations
{
    ...
    [Migration("20230414151401_intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ataal.DAL.Data.Models.Problems_Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KeyWordsProblem", b =>
                {
                    b.Property<int>("KeyWordsKeyWord_ID")
                        .HasColumnType("int");

                    b.Property<int>("ProblemsProblem_ID")
                        .HasColumnType("int");

                    b.HasKey("KeyWordsKeyWord_ID", "ProblemsProblem_ID");

                    b.HasIndex("ProblemsProblem_ID");

                    b.ToTable("KeyWordsProblem");
                });
            ...
            modelBuilder.Entity("KeyWordsProblem", b =>
                {
                    b.HasOne("Ataal.DAL.Data.Models.KeyWords", null)
                        .WithMany()
                        .HasForeignKey("KeyWordsKeyWord_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ataal.DAL.Data.Models.Problem", null)
                        .WithMany()
                        .HasForeignKey("ProblemsProblem_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
